...
public class Cnpj extends Documento{
	...
	public void isCNPJ(String CNPJ) throws CnpjException{
		...
		if (CNPJ.equals("00000000000000") || CNPJ.equals("11111111111111")
			...
			throw new CnpjException("CNPJ's formados por uma sequencia de numeros iguais");
		...
		try {
			...
			if (!(dig13 == CNPJ.charAt(12)) && (dig14 == CNPJ.charAt(13))){
				throw new CnpjException("Dígitos calculados não conferem com os dígitos informados.");
			}
				
		} catch (InputMismatchException erro) {
			throw new CnpjException("Erros de conversao de tipo");
